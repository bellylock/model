$(function(){
			...
			$(".kuang2").on("click",function(){
				if($(".kuang2").hasClass("duigou")){
					$(this).removeClass("duigou");
				}else{
					$(this).addClass("duigou");
				}
               ...
               // $(".fk").on("click",function(item){
               //      // var index = $(this).attr("index");
               //      if($(".fk").hasClass("duigou")){
    ...
    var provinceOption = "<option>请选择地区</option>";
    ...
    $("#province").on("change",function(){
        ...
        if(cityIndex != -1){
            var option = "<option>请选择市县</option>";
            ...
            $("#city").on("change",function(){
                ...
                if(townIndex != -1){
                    var townOption = "<option>请选择城市</option>";
    ...
    var array = [
          {img:"images/main-1.jpg",a:"找相似",price:"￥8869",s:"￥12869",te:"特价",p:"[彼岸阳光] 地中海风格 小资情调 精品桦木框架 高回弹公仔棉填充 U型清新布艺沙发（1+3+左贵妃",sail:"已售",num:2896,pin:"评论106",check:false,flag:true},
          {img:"images/main-2.jpg",a:"找相似",price:"￥7980",p:"爱上家 地中海L型转角实木布艺沙发组合 大小户型客厅可拆洗沙发",sail:"已售",num:4360,pin:"评论93",check:false,flag:false},
          {img:"images/main-3.jpg",a:"找相似",price:"￥5380",p:"太子家居 欧式布艺沙发贵妃转角大小户型L型客厅拆洗沙发 SD-2202",sail:"已售",num:1976,pin:"评论63",check:false,flag:false},
          {img:"images/main-4.jpg",a:"找相似",price:"￥3199",p:"和购家具 韩式田园布艺沙发组合小户型客厅单人三人转角沙发HG780",sail:"已售",num:4509,pin:"评论87",check:false,flag:false},
          {img:"images/main-5.jpg",a:"找相似",price:"￥4771",p:"全实木沙发组合 松木三人沙发椅 布艺客厅中式木质沙发床实木家具",sail:"已售",num:3467,pin:"评论96",check:false,flag:false},
          {img:"images/main-6.jpg",a:"找相似",price:"￥7390",p:"原始原素北欧简约全实木沙发贵妃客厅转角白橡木布艺沙发组合家具",sail:"已售",num:2585,pin:"评论67",check:false,flag:false},
          {img:"images/main-7.jpg",a:"找相似",price:"￥3498",p:"全友家私棉麻皮布沙发组合带转角现代田园可拆洗客厅家具085",sail:"已售",num:2534,pin:"评论76",check:false,flag:false},
          {img:"images/main-8.jpg",a:"找相似",price:"￥8884",p:"华日家居 美式田园实木沙发 单人\双人\三人位 实木沙发 客厅家具",sail:"已售",num:2235,pin:"评论53",check:false,flag:false},
          {img:"images/main-9.jpg",a:"找相似",price:"￥5410",p:"华日家居 美式田园实木转角沙发 三人位+踏 实木沙发组合客厅家具",sail:"已售",num:2556,pin:"评论96",check:false,flag:false},
          {img:"images/main-10.jpg",a:"找相似",price:"￥1460",p:"源氏木语进口白橡木实木沙发自由组合可拆洗垫子美式乡村客厅家具",sail:"已售",num:3415,pin:"评论97",check:false,flag:false},
          {img:"images/main-11.jpg",a:"找相似",price:"￥5784",p:"优梵艺术 Rhine美式布艺沙发组合小户型实木皮布沙发客厅U型家具",sail:"已售",num:2385,pin:"评论94",check:false,flag:false},
          {img:"images/main-12.jpg",a:"找相似",price:"￥13205",p:"华日家居 美式田园实木沙发 单人\双人\三人位 实木沙发 客厅家具",sail:"已售",num:1956,pin:"评论73",check:false,flag:false},
          {img:"images/main-13.jpg",a:"找相似",price:"￥4280",p:"地中海田园沙发 美式乡村布艺棉麻实木 拆洗简约欧式客厅沙发",sail:"已售",num:4085,pin:"评论89",check:false,flag:false},
          {img:"images/main-14.jpg",a:"找相似",price:"￥1299",p:"喜梦宝实木沙发客厅茶几电视柜 简约田园实木布艺沙发 薇娅",sail:"已售",num:5585,pin:"评论128",check:false,flag:false},
          {img:"images/main-15.jpg",a:"找相似",price:"￥3699",p:"诗雅轩家具 韩式田园布艺沙发组合小户型简约三人转角沙发HS6019",sail:"已售",num:3585,pin:"评论87",check:false,flag:false}
    ];
    var up = [
          {img:"images/guess-1.jpg",price:"￥8869",p:"圣蒂斯堡地中海全实木布艺沙发客厅小户型小清新田园三人沙发组合",sail:"已售",num:3578,pin:"评论86",check:false},
          {img:"images/guess-2.jpg",price:"￥1720",p:"诗雅轩 韩式田园布艺沙发组合 小户型客厅家具 可拆洗转角HG780",sail:"已售",num:2585,pin:"评论67",check:false},
          {img:"images/guess-3.jpg",price:"￥8869",p:"浪漫坊 田园布艺沙发实木地中海风格沙发 小户型布艺沙发组合预售",sail:"已售",num:6840,pin:"评论106",check:false}
    ]
    ...
    var app = new Vue({
          ...
          methods:{
               ...
               join:function(item){
                    var shopcar = localStorage.getItem("msg");
                    if( shopcar == null){
                         var array = [];
                         var obj ={
                              img:item.img,
                         ...
                         localStorage.setItem("msg",arrayStr)
                    }else{
                         ...
                         shopcar.push(obj);
                         var arrayStr = JSON.stringify(shopcar);
                         localStorage.setItem("msg",arrayStr);
                    }
               }
          },
