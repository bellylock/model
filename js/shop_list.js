$(function(){
			...
			$(".kuang2").on("click",function(){
               ...
               $(".fk").on("click",function(){
                    ...
                    if($($(".fk")[index]).hasClass("duigou")){
                         $($(".fk")[index]).removeClass("duigou");
                    }else{
                         $($(".fk")[index]).addClass("duigou");
                    }
               });
    ...
    $(".join").on("click",function(){
          ...
          if (shopCar == null) {
               var array = [];
               var obj = {
                    img :$(".portrayal:first").attr("src"),
                    p:$(".main p.title").text(),
                    span:$(".main p.text").text(),
                    price:$(".main .active").text(),
                    number:1
               };
               array.push(obj);
               var arrayString = JSON.stringify(array);
               localStorage.setItem("shop",arrayString)
          }else{
               var shopCar = JSON.parse(shopCar);
               var obj = {
                    img :$(".portrayal:first").attr("src"),
                    p:$(".main p.title").text(),
                    span:$(".main p.text").text(),
               ...
               shopCar.push(obj);
               var arrayString = JSON.stringify(shopCar);
               localStorage.setItem("shop",arrayString);
          }
          console.log(array,arrayString,shopCar)
     });
    ...
    $(".joinCar").on("click",function(){
          ...
          if (shopCar == null) {
               var array = [];
               var obj = {
                    img :$(".pic:first").attr("src"),
                    p:$(".matter p.title").text(),
                    span:$(".matter p.text").text(),
                    price:$(".matter .active").text(),
                    number:1
               };
               array.push(obj);
               var arrayString = JSON.stringify(array);
