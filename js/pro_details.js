$(function(){
	$(".smallpic").hover(function(){
     ...
     $(".hush").on("click",function(){
          $(".hush").removeClass('active');
          $(this).addClass('active');
     });
     ...
     $(".next").on("click",function(){                 
          if(page==pageNum){$ul.animate({left:"0"},1000); page = 1;}
          else{ $ul.animate({left:"-=" + $width},1000); page++;} 
     });
	...
	$(".val").on("input",function(){
     ...
     //加入购物车
     $(".joinShopCar").on("click",function(){
          var localStorage = window.localStorage;
          var shopCar = localStorage.getItem("shop");
          if (shopCar == null) {
               var array = [];
               var obj = {
                    img :$(".smallpic:first").attr("src"),
                    p:$(".mid p.title").text(),
                    span:$(".type .active").text(),
    ...
    var provinceOption = "<option>广东广州天河区</option>";
